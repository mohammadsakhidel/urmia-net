...
namespace SocialNetApp.Views.Models.Modules
{
    public class PostActivityModel
    {
        ...
        #region Methods:
        public static PostActivityModel Create(Activity activity, Dictionary<string, object> param, System.Data.Objects.ObjectContext context)
        {
            var model = new PostActivityModel();
            model.Activity = (PostActivity)activity;
