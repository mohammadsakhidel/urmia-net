...
{
    public class SkillActivityModel
    {
        #region Properties:
        #endregion
        public SkillActivity Activity { get; set; }
        ...
        //******
        #region Methods:
        public static SkillActivityModel Create(Activity activity, Dictionary<string, object> param, System.Data.Objects.ObjectContext context)
        {
            var model = new SkillActivityModel();
            model.Activity = (SkillActivity)activity;
            ...
            if (model.IsActivityVisibleToUser)
            {
                ...
                model.Skill = model.Activity.Skill;
                //****** modules models:
